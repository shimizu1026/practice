...
const data = document.querySelector("[data-button]");
...
data.addEventListener("click", (event) => {
	...
	const isExpanded = data.getAttribute("aria-expanded");
	const next = isExpanded === "false" ? "true" : "false";
	data.setAttribute("aria-expanded", next);
	...
	drawer.setAttribute("aria-hidden", next === "true" ? "false" : "true");
});
