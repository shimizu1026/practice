...
const createPokemon = (name, type, level) => {
	return {
		name: name,
		type: type,
		level: level,
...
const pikachu = createPokemon("ピカチュウ", "でんき", 1);
const hitokage = createPokemon("ヒトカゲ", "ほのお", 5);
const zenigame = createPokemon("ゼニガメ", "みず", 5);
