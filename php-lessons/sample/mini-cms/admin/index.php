  ...
  <main class="l-main">
    <div class="l-wrapper">
      ...
      <nav class="paging-nav">
        ...
        <ul>
          <?php if ( $page > 1 ) : ?>
          <li><a href="index.php?page=<?php echo h( $page - 1 ); ?>" class="button button-primary">前のページへ</a></li>
          <?php endif; ?>
          <?php if ( $page < $total ) : ?>
          <li><a href="index.php?page=<?php echo h( $page + 1 ); ?>" class="button button-primary">次のページへ</a></li>
          <?php endif; ?>
        </ul>
      </nav>
    </div>
