        ...
        <section class="p-articles">
          ...
          <article class="c-media p-article">
            <div class="c-media__body">
              ...
              <?php else : ?>
                <img src="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/no-picture.png" srcset="<?php echo esc_url(get_theme_file_uri()); ?>/assets/images/no-picture.png, <?php echo esc_url(get_theme_file_uri()); ?>/assets/images/no-picture@2x.png 2x" alt="">
              <?php endif; ?>
              </figure>
            <!-- /.c-media__thumbnail -->
          </article>
